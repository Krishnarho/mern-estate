...
export default function CreateListing() {
    ...
    const handleChange = (e) => {
        ...
        if (e.target.id === 'parking' || e.target.id === 'furnished' || e.target.id === 'offer') { setFormData({ ...formData, [e.target.id]: e.target.checked }) } // key with [] takes the value of variable inside the brakets.  
        if (e.target.type === 'number' || e.target.type === 'text' || e.target.type === 'textarea') { setFormData({ ...formData, [e.target.id]: e.target.value }) }
    }
